      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="relative flex-1 max-w-xs mx-6">
          ...
          <input
            ...
            className="h-10 pl-10 pr-4 w-full rounded-lg border border-gray-300 bg-gray-50 
              text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
          />
        </div>
        <Link href="/add-product">
          <button className="px-5 py-2 rounded-lg bg-gray-900 text-white font-semibold hover:bg-gray-800 
